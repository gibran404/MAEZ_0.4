...
public class AreaFloorBaker : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        // Initialize WorldAnchor with the player's starting position
    ...
    private void BuildNavMesh(bool Async)
    {
        ...
        // Clear the Sources list to avoid accumulating sources from previous builds
        Sources.Clear();
        ...
        for (int index = 0; index < Surfaces.Length; index++)
        {
            ...
            for (int i = 0; i < modifiers.Count; i++)
            {
                ...
                if (((Surfaces[index].layerMask & (1 << modifiers[i].gameObject.layer)) != 0)
